...
function CommonFunctions () {
  ...
  this.clickBackOrClose = function (package, repeatTime) {
    ...
    if ((backOrColse = this._widgetUtils.widgetGetOne('返回.*|关闭', 500, false, false ,(m) =>
          ...
          if (descView) {
            ...
            if (sliderBtn) {
              ...
              if (sliderText) {
                ...
                let sx = automator.randomRange(slider_bound.right, slider_bound.right+30)
                let sy = automator.randomRange(slider_bound.top, slider_bound.bottom)
                let duration = automator.randomRange(1000,2000)
